...
// @ts-ignore
import { enviarCadastroPf } from "../apiConfig";
import { toast } from "react-toastify";
import axios from "axios";
import "../style.css";

// Função para formatar CPF (ou, se acidentalmente, CNPJ) – para PF, normalmente o CPF tem até 11 dígitos
function formatCpfCnpj(value: string): string {
  ...
  if (value.length <= 11) {
    ...
    // Caso venha um CNPJ por acidente, formata como CNPJ
...
// Mapeamentos para os selects
const instalacaoMapping: Record<string, string> = {
  "1": "R$0,00 - Com Fidelidade de 12 Meses",
...
const PF = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Construindo a observação usando os textos dos selects
    let observacao = formData.observacao || "";
    if (formData.ponto_adicional && formData.ponto_adicional !== "") {
      const pontoAdicionalText =
        pontoAdicionalMapping[formData.ponto_adicional] || "";
    ...
    // Monta o payload, substituindo os valores numéricos pelos textos correspondentes
    const dadosParaEnvio = {
      ...
      ponto_adicional: formData.ponto_adicional
        ? pontoAdicionalMapping[formData.ponto_adicional]
        : "",
      observacao,
      pais: "BR",
    ...
    try {
      setIsLoading(true);
      await enviarCadastroPf(dadosParaEnvio);
      toast.success("Pré-cadastro realizado com sucesso!");
      setTimeout(() => navigate("/sucesso"), 2000);
    } catch (error) {
      // A API já exibe o toast de erro, portanto apenas logamos o erro aqui.
      console.error("Erro ao enviar seu formulário:", error);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="page-container">
      <div className="outer-container">
        <header className="header-container">
          ...
          <h1 className="title">Pré-Cadastro de Pessoa Física</h1>
        </header>
            ...
            <div className="pj-form-grid">
              ...
              <div className="form-group">
                ...
                <select name="instalacao" value={formData.instalacao} onChange={handleChange} required>
                  ...
                  <option value="1">R$0,00 - Com Fidelidade de 12 Meses</option>
